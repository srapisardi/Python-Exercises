...
class Asteroid(Wrapper):
    ...
    def die(self):
        ...
        if Asteroid.total == 0 and Asteroid.total == 0:
            self.game.advance()

        super(Asteroid, self).die()

class Enemy(Wrapper):
    image = games.load_image("enemy.png")
    ...
    def __init__ (self, game, x, y):
        ...
        super(Enemy, self).__init__(image = Enemy.image,
                                    x = x,
                                    y = y,
                                    dx = random.choice([1,-1]) * Enemy.SPEED,
                                    dy = random.choice([1, -1]) * Enemy.SPEED)
    ...
    def die(self):
        ...
        if Enemy.total == 0 and Asteroid.total == 0:
            self.game.advance()
