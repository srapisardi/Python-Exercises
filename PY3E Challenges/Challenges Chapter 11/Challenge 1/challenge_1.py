...
# Challenge 1 Improve Pizza Panic game by increasing its difficulty as the game progresses.
...
class Pan(games.Sprite):
    ...
    def check_catch(self):
        """ Check if catch pizzas. Challenge 1 Improvement"""
        for pizza in self.overlapping_sprites:
            self.score.value += 10
            self.score.right = games.screen.width - 10
            if self.score.value == 200:
                Pizza.speed += 1
            elif self.score.value == 400:
                Pizza.speed += 1
            elif self.score.value == 600:
                Pizza.speed += 1
            pizza.handle_caught()
